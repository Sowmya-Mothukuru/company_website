...
export default function AiServices() {
  ...
  return (
    <motion.section
      className="w-full bg-[#F8FBFF] flex justify-center py-[40px] -mt-[120px] pt-[140px]"
      variants={container}
      initial="hidden"
      whileInView="show"
      viewport={{ once: true }}
    >
      <div className="max-w-[1257px] w-full px-6 flex flex-col items-center">
        ...
        <motion.div
          variants={fadeUp}
          className="max-w-[900px] text-center font-['Space_Grotesk']"
        >
        ...
        <motion.div
          variants={container}
          className="mt-[70px] w-full flex flex-col gap-6"
        >
