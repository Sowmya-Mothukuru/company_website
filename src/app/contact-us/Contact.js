    ...
    <div className="w-full relative bg-[#F8FBFF]">
      ...
      <div
        className="
          ...
          px-4 sm:px-6   /* ✅ UPDATED (better mobile padding) */
          flex flex-col items-center
          pt-[60px] sm:pt-[80px]   /* ✅ UPDATED */
          gap-[32px] sm:gap-[40px]   /* ✅ UPDATED */
          relative z-10
        "
      >

        {/* HEADER */}
        <header className="text-center mb-10 sm:mb-16 max-w-[722px] w-full"> {/* ✅ UPDATED */}
          <h1 className="text-[26px] sm:text-[30px] md:text-[36px] font-bold text-black mb-4 sm:mb-6 tracking-tight"> {/* ✅ UPDATED */}
            Let's Build Together
          </h1>

          <p className="text-[#5D5D5D] text-[16px] sm:text-[18px] md:text-[20px]"> {/* ✅ UPDATED */}
            Tell us about your idea, product, or challenge
          </p>
        </header>
        ...
        <div
          className="
            ...
            rounded-[12px] sm:rounded-[15px]   /* ✅ UPDATED */
            shadow-sm

            px-4 sm:px-6 md:px-12 lg:px-[120px]   /* ✅ UPDATED */
            py-6 sm:py-8 md:py-10 lg:py-12   /* ✅ UPDATED */

            max-h-none   /* ✅ UPDATED (fix overflow on mobile) */
          "
        >

          <div className="relative z-10">

            <h2 className="text-[22px] sm:text-[24px] md:text-[28px] font-bold text-black mb-4"> {/* ✅ UPDATED */}
              Drop us a line!
            </h2>

            <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 md:gap-10 lg:gap-16"> {/* ✅ UPDATED */}

              {/* LEFT */}
              <div className="flex-1 flex flex-col gap-5 sm:gap-6"> {/* ✅ UPDATED */}

                <div className="space-y-2">
                  <label className="block text-[13px] sm:text-sm font-bold text-gray-800"> {/* ✅ UPDATED */}
                    Your Name
                  </label>
                ...
                <p className="text-[14px] sm:text-[15px] md:text-[16px] text-gray-800 font-medium break-words"> {/* ✅ UPDATED */}
                  or send us an email to{" "}
                  <span className="font-bold">info@glichbrainer.com</span>
                </p>
              ...
              <div className="flex-1 flex flex-col gap-5 sm:gap-6"> {/* ✅ UPDATED */}
                ...
                <p className="text-[14px] sm:text-[16px] md:text-[18px] lg:text-[20px] text-gray-800 leading-snug"> {/* ✅ UPDATED */}
                  By submitting this, I confirm that I have read and understood the{" "}
                  <a
                    href="#"
                    className="underline font-bold hover:text-blue-700 transition-colors"
                ...
                <button
                  className="
                    w-full h-[44px] sm:h-[46px] md:h-[48px]   /* ✅ UPDATED */
                    flex items-center justify-center gap-[10px]
                    px-[18px] rounded-[14px] sm:rounded-[16px]   /* ✅ UPDATED */
                    bg-[#2F3E4E] text-white font-semibold
                    hover:bg-[#1f2933] transition-all shadow-md active:scale-[0.98]
                    text-[14px] sm:text-[15px] md:text-[16px]   /* ✅ UPDATED */
                  "
                >
                  Send Me Message
                </button>
